...
HOW_TO = (
    ...
    "🔖 Закладка — кнопка с закладкой вверху слева. "
    "Нажми, чтобы добавить книгу в папку «Закладки». "
    "Нажми ещё раз — уберёшь. Когда кнопка подсвечена, книга уже в закладках.\n\n"
