...
START_TEXT = (
    "Привет! Это Readbook — твоя личная библиотека и читалка.\n\n"
    "Открой приложение кнопкой ниже (или «Библиотека» рядом с полем ввода).\n\n"
    "Что внутри:\n"
    "🔍 Поиск — пишешь название или автора, видишь обложки, открываешь книгу.\n"
    "📚 Библиотека — папки «продолжить чтение», «закладки» и «читать дальше».\n"
    "Внутри папки книги показаны обложками; любую можно убрать.\n\n"
    "Можно просто написать название книги сюда в чат — пришлю подборку.\n\n"
    "Подробно про каждую кнопку — команда /help."
)
...
async def run_bot() -> None:
    ...
    await bot.set_my_short_description("Личная библиотека и читалка Readbook")
    await bot.set_my_description(
        "Readbook — поиск книг по обложкам, закладки и читалка внутри Telegram.\n\n"
        "Нажми «Библиотека» или /start, чтобы открыть приложение.\n"
        "/help — что означает каждая кнопка."
    )
